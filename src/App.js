      ...
      <div className="App" style={{background: '#e2edff'}}>
        <nav class="navbar navbar-dark bg-dark">
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="#">Music by Mood</a>
          </nav>
        </nav>
        <div className="col-12 pt-5">
          <div className="row">
            <div className="col-3">
              ...
              <Dropdown options={moodOptions} onChange={this._onSelect} value={defaultMoodOption} placeholder="Select an option" />
            </div>
            <div className="col-3">
              <div>
                <h2>Sort by:</h2>
              </div>
              <Dropdown options={selectOptions} onChange={this._onSelect} value={defaultSelectOption} placeholder="Select an option" />
              <div className="d-flex pt-5">
                <button type="button" className="btn btn-success btn-lg ml-auto">Go Search</button>
              </div>
            </div>
            <div className="col-6">
              <div className="row">
                <div className="col-8">
                  <div>
                    <img style={{width: '75%', height: '50%'}} className="pt-5" src={album1}/>
                    <div>
                ...
                <div className="col-4" style={{ borderLeft: '1px solid black'}}>
                  ...
                  <div style={this.state.activeIndex == 1 ? {background: '#cecece', borderRadius: 20} : {}}>
                    <img style={{width: 100, height: 100}} className="pt-4" src={album2} onClick={()=>this.onDisplayActive(1)}/>
                    <div>
                      <h4>song2</h4>
                    </div>
                  </div>
                  <div style={this.state.activeIndex == 2 ? {background: '#cecece', borderRadius: 20} : {}}>
                    <img style={{width: 100, height: 100}} className="pt-4" src={album3} onClick={()=>this.onDisplayActive(2)}/>
                    <div>
                      <h4>song3</h4>
                    </div>
                  </div>
                  <div style={this.state.activeIndex == 3 ? {background: '#cecece', borderRadius: 20} : {}}>
                    <img style={{width: 100, height: 100}} className="pt-4" src={album4} onClick={()=>this.onDisplayActive(3)}/>
                    <div>
                      <h4>song4</h4>
                    </div>
                  </div>
